...
echo $appdir    = '!APPDIR!'                                                                 > "!_PS!"
echo $raw       = '!GITHUB_RAW!'                                                            >> "!_PS!"
echo $html      = Get-Content -LiteralPath "$appdir\course-viewer.html" -Raw -EA SilentlyContinue >> "!_PS!"
echo $localVer  = ''                                                                         >> "!_PS!"
...
echo   Write-Host ""                                                                          >> "!_PS!"
echo   Write-Host "  Updating v$localVer -> v$latestVer..."                                 >> "!_PS!"
echo   foreach ($f in @('proxy.py', 'course-viewer.html')) {                                >> "!_PS!"
echo     Invoke-WebRequest -Uri "$raw/$f" -OutFile "$appdir\$f" -UseBasicParsing            >> "!_PS!"
